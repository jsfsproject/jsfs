...
namespace com.wilutions.jsfs
{
	...
	public sealed class BRequest_DispatcherService_unregisterService : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.UnregisterService(tokenValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1542825705L;		
	} // end class
}  // end namespace
