...
namespace com.wilutions.jsfs
{
	...
	public sealed class BRequest_FileSystemService_uploadFiles : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.UploadFiles(itemsValue, urlValue, methodValue, encodingValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal String encodingValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 1614176016L;		
	} // end class
}  // end namespace
